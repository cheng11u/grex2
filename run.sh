...
--data ../data/UD_French-GSD-master_UD_French-ParisStories-master_1000.conllu \
...
python extract_rules.py \
--data ../data/UD_French-GSD-master_UD_French-ParisStories-master_2000.conllu \
...
python extract_rules.py \
--data ../data/UD_French-GSD-master_UD_French-ParisStories-master_2776.conllu \
...
### verbs
python extract_rules.py \
--data ../data/UD_French-GSD-master_UD_Romanian-RRT-master_1000.conllu \
...
python extract_rules.py \
--data ../data/UD_French-GSD-master_UD_Romanian-RRT-master_2000.conllu \
...
python extract_rules.py \
--data ../data/UD_French-GSD-master_UD_Romanian-RRT-master_3000.conllu \
...
### verbs
python extract_rules.py \
--data ../data/UD_Spanish-GSD-master_UD_Romanian-RRT-master_1000.conllu \
...
python extract_rules.py \
--data ../data/UD_Spanish-GSD-master_UD_Romanian-RRT-master_2000.conllu \
...
python extract_rules.py \
--data ../data/UD_Spanish-GSD-master_UD_Romanian-RRT-master_3000.conllu \
